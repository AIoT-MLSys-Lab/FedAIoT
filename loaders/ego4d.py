...
from loaders.utils import _get_frames
...
class StateChangeDetectionAndKeyframeLocalisation(torch.utils.data.Dataset):
    ...
    def _construct_loader(self):
        ...
        self.uniq_vid_ids = {v: k for k, v in enumerate(list(set(self.video_ids)))}
        self.targets = [self.uniq_vid_ids[k] for k in self.video_ids]
