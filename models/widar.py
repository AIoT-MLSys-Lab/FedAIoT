...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, i_downsample=None, stride=1):
        ...
        self.batch_norm1 = ResNetCustomNorm(out_channels)

        self.conv2 = nn.Conv2d(out_channels, out_channels, kernel_size=3, stride=stride, padding=1)
        self.batch_norm2 = ResNetCustomNorm(out_channels)

        self.conv3 = nn.Conv2d(out_channels, out_channels * self.expansion, kernel_size=1, stride=1, padding=0)
        self.batch_norm3 = ResNetCustomNorm(out_channels * self.expansion)
...
class Widar_ResNet(nn.Module):
    def __init__(self, ResBlock, layer_list, num_classes):
        ...
        self.batch_norm1 = ResNetCustomNorm(64)
        self.relu = nn.ReLU()
    ...
    def _make_layer(self, ResBlock, blocks, planes, stride=1):
        ...
        if stride != 1 or self.in_channels != planes * ResBlock.expansion:
            ii_downsample = nn.Sequential(
                ...
                ResNetCustomNorm(planes * ResBlock.expansion)
            )
...
def Widar_ResNet18(num_classes) -> Widar_ResNet:
...
def Widar_ResNet101(num_classes) -> Widar_ResNet:
